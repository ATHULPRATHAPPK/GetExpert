      ...
      <div className=" w-full bg-gray-100">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 m-1">
              {[
                ...
                <div
                  key={service}
                  className="bg-white p-6 rounded-lg shadow-lg text-center transition-transform transform hover:scale-105 hover:shadow-xl"
                >
                  <h3 className="text-l font-semibold mb-1">{service}</h3>
                </div>
              ))}
            </div>
      </div>
